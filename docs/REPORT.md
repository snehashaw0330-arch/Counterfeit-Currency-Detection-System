...
### 5.2 Whole-system end-to-end (`evaluate_system.py`, all 65 images)

| ground truth ↓ / verdict → | REAL | SUSPICIOUS | FAKE |
|---|---|---|---|
| **genuine** | 30 | 12 | 0 |
| **fake** | 9 | 8 | 6 |

- **0% false positives** — never calls a genuine note FAKE.
- **71%** of genuine notes cleared as REAL (rest flagged SUSPICIOUS for review).
- **~61%** of fakes flagged (FAKE or SUSPICIOUS); ~39% (high-quality physical
  fakes) pass as REAL — the dangerous false-negative case.
